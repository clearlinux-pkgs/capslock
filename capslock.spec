...
Version  : 0.2.1
Release  : 2
URL      : https://github.com/google/capslock/archive/v0.2.1/capslock-0.2.1.tar.gz
Source0  : https://github.com/google/capslock/archive/v0.2.1/capslock-0.2.1.tar.gz
Source1  : http://localhost/cgit/projects/capslock-vendor/snapshot/capslock-vendor-0.2.1.tar.xz
...
%prep
%setup -q -n capslock-0.2.1
cd %{_builddir}
tar xf %{_sourcedir}/capslock-vendor-0.2.1.tar.xz
cd %{_builddir}/capslock-0.2.1
mkdir -p ./
cp -r %{_builddir}/capslock-vendor-0.2.1/* %{_builddir}/capslock-0.2.1/./
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708989281
